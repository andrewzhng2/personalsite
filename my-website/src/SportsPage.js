...
const sports = [
  { name: "Basketball", image: ball1, image2: ball2, description: "My one true addiction, I don't think I'd understand life without basketball. Shoot your shot, brick by brick, play the pace, no ego, for the love of the game <3" },
  ...
  { name: "Sport Climbing", image: climb1, image2: climb2, description: "I can tell you that NOTHING wakes you up faster than falling 30 feet. But then you try again and just go up. I love bouldering, lead climbing, and ice climbing." },
  ...
  { name: "Golf", image: golf1, image2: golf2, description: "My dad's favourite (and only) sport that he plays. This sport is just pure mental warfare. I wish my shots didn't slice so hard." }
];
